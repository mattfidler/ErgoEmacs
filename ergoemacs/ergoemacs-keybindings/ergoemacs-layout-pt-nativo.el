...
;; Move by paragraph
(defconst ergoemacs-backward-block-key (kbd "M-L"))
(defconst ergoemacs-forward-block-key (kbd "M-C"))
...
(defconst ergoemacs-backward-open-bracket-key (kbd "M-D"))
(defconst ergoemacs-forward-close-bracket-key (kbd "M-R"))

;; isearch
(defconst ergoemacs-isearch-forward-key (kbd "M-w"))
(defconst ergoemacs-isearch-backward-key (kbd "M-W"))
...
; Cancel
(defconst ergoemacs-keyboard-quit-key (kbd "<escape>"))
